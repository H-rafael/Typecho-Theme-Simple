...
function any_md5(t, n) {
    return rstr2any(rstr_md5(str2rstr_utf8(t)), n)
}
function hex_hmac_md5(t, n) {
    return rstr2hex(rstr_hmac_md5(str2rstr_utf8(t), str2rstr_utf8(n)))
}
function b64_hmac_md5(t, n) {
    return rstr2b64(rstr_hmac_md5(str2rstr_utf8(t), str2rstr_utf8(n)))
}
function any_hmac_md5(t, n, e) {
    return rstr2any(rstr_hmac_md5(str2rstr_utf8(t), str2rstr_utf8(n)), e)
}
...
function rstr_hmac_md5(t, n) {
    var e = rstr2binl(t);
    16 < e.length && (e = binl_md5(e, 8 * t.length));
    for (var o = Array(16), i = Array(16), r = 0; r < 16; r++) o[r] = 909522486 ^ e[r],
        i[r] = 1549556828 ^ e[r];
    var a = binl_md5(o.concat(rstr2binl(n)), 512 + 8 * n.length);
    return binl2rstr(binl_md5(i.concat(a), 640))
}
function rstr2hex(t) {
...
function rstr2b64(t) {
    for (var n = "",
             e = t.length,
             o = 0; o < e; o += 3) for (var i = t.charCodeAt(o) << 16 | (o + 1 < e ? t.charCodeAt(o + 1) << 8 : 0) | (o + 2 < e ? t.charCodeAt(o + 2) : 0), r = 0; r < 4; r++) 8 * o + 6 * r > 8 * t.length ? n += b64pad: n += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(i >>> 6 * (3 - r) & 63);
    return n
}
function rstr2any(t, n) {
    var e, o, i, r, a, s = n.length,
        c = Array(Math.ceil(t.length / 2));
    for (e = 0; e < c.length; e++) c[e] = t.charCodeAt(2 * e) << 8 | t.charCodeAt(2 * e + 1);
    var l = Math.ceil(8 * t.length / (Math.log(n.length) / Math.log(2))),
        d = Array(l);
    for (o = 0; o < l; o++) {
        for (a = Array(), e = r = 0; e < c.length; e++) r = (r << 16) + c[e],
            r -= (i = Math.floor(r / s)) * s,
        (0 < a.length || 0 < i) && (a[a.length] = i);
        d[o] = r,
            c = a
    }
    var m = "";
    for (e = d.length - 1; 0 <= e; e--) m += n.charAt(d[e]);
    return m
}
...
function str2rstr_utf16le(t) {
    for (var n = "",
             e = 0; e < t.length; e++) n += String.fromCharCode(255 & t.charCodeAt(e), t.charCodeAt(e) >>> 8 & 255);
    return n
}
function str2rstr_utf16be(t) {
    for (var n = "",
             e = 0; e < t.length; e++) n += String.fromCharCode(t.charCodeAt(e) >>> 8 & 255, 255 & t.charCodeAt(e));
    return n
}
...
function bit_rol(t, n) {
    ...
    function() {
        function e(t, n) {
            ...
            o.className = "notyf-wrapper";
            var i = document.createElement("div");
            i.className = "notyf-icon";
            var r = document.createElement("i");
            r.className = n;
            var a = document.createElement("div");
            a.className = "notyf-message",
                a.innerHTML = t,
                i.appendChild(r),
                o.appendChild(i),
                o.appendChild(a),
            ...
            return setTimeout(function() {
                    e.className += " disappear",
                        e.addEventListener(s.animationEnd,
                            function(t) {
                                t.target == e && s.container.removeChild(e)
                            });
                    var t = s.notifications.indexOf(e);
        ...
        this.Notyf = function() {
            ...
            arguments[0] && "object" == typeof arguments[0] ? this.options = function(t, n) {
                for (property in n) n.hasOwnProperty(property) && (t[property] = n[property]);
                return t
            } (t, arguments[0]) : this.options = t;
            var n = document.createDocumentFragment(),
                e = document.createElement("div");
            e.className = "notyf-container",
                n.appendChild(e),
                document.body.appendChild(n),
                this.container = e,
                this.animationEnd = function() {
                    var t, n = document.createElement("fake"),
                        e = {
            ...
            this.Notyf.prototype.alert = function(t) {
                var n = e.call(this, t, this.options.alertIcon);
                n.className += " alert",
                    this.container.appendChild(n),
                    this.notifications.push(n)
            },
            this.Notyf.prototype.confirm = function(t) {
                var n = e.call(this, t, this.options.confirmIcon);
                n.className += " confirm",
                    this.container.appendChild(n),
                    this.notifications.push(n)
            }
    ...
    function(t, n) {
        "function" == typeof define && define.amd ? define([],
            function() {
                return n(t)
            }) : "object" == typeof exports ? module.exports = n(t) : t.SmoothScroll = n(t)
        ...
        function($) {
            ...
            var C = {
                ...
                c = function(t) {
                    ...
                    for (var n, e = String(t), o = e.length, i = -1, r = "", a = e.charCodeAt(0); ++i < o;) {
                        if (0 === (n = e.charCodeAt(i))) throw new InvalidCharacterError("Invalid character: the input contains U+0000.");
                        r += 1 <= n && n <= 31 || 127 == n || 0 === i && 48 <= n && n <= 57 || 1 === i && 48 <= n && n <= 57 && 45 === a ? "\\" + n.toString(16) + " ": 128 <= n || 45 === n || 95 === n || 48 <= n && n <= 57 || 65 <= n && n <= 90 || 97 <= n && n <= 122 ? e.charAt(i) : "\\" + e.charAt(i)
                    }
                    var s;
                    try {
                ...
                A = function(t) {
                    return t ? (n = t, parseInt($.getComputedStyle(n).height, 10) + t.offsetTop) : 0;
                    var n
                }, S = function(t, n, e, o) {
                    if (n.emitEvents && "function" == typeof $.CustomEvent) {
            ...
            return function(o, t) {
                ...
                w.animateScroll = function(a, s, t) {
                    var n, e, c = O(y || C, t || {}),
                        l = "[object Number]" === Object.prototype.toString.call(a),
                        o = l || !a.tagName ? null: a;
                    if (l || o) {
                        var d = $.pageYOffset;
                        c.header && !_ && (_ = document.querySelector(c.header)),
                        b || (b = A(_));
                        var m, i, r, u = l ? a: function(t, n, e, o) {
                                var i = 0;
                                if (t.offsetParent) for (; i += t.offsetTop, t = t.offsetParent;);
                                return i = Math.max(i - n - e, 0),
                                o && (i = Math.min(i, x() - $.innerHeight)),
                                    i
                            } (o, b, parseInt("function" == typeof c.offset ? c.offset(a, s) : c.offset, 10), c.clip),
                            h = u - d,
                            f = x(),
                            p = 0,
                            g = function(t, n) {
                                var e, o, i, r = $.pageYOffset;
                                if (t == n || r == n || (d < n && $.innerHeight + r) >= f) return w.cancelScroll(!0),
                                    o = n,
                                    i = l,
                                0 === (e = a) && document.body.focus(),
                                i || (e.focus(), document.activeElement !== e && (e.setAttribute("tabindex", "-1"), e.focus(), e.style.outline = "none"), $.scrollTo(0, o)),
                                    S("scrollStop", c, a, s),
                                    !(E = m = null)
                            },
                            v = function(t) {
                                var n, e, o;
                                m || (m = t),
                                    i = (p += t - m) / parseInt(c.speed, 10),
                                    r = d + h * (e = i = 1 < i ? 1 : i, "easeInQuad" === (n = c).easing && (o = e * e), "easeOutQuad" === n.easing && (o = e * (2 - e)), "easeInOutQuad" === n.easing && (o = e < .5 ? 2 * e * e: (4 - 2 * e) * e - 1), "easeInCubic" === n.easing && (o = e * e * e), "easeOutCubic" === n.easing && (o = --e * e * e + 1), "easeInOutCubic" === n.easing && (o = e < .5 ? 4 * e * e * e: (e - 1) * (2 * e - 2) * (2 * e - 2) + 1), "easeInQuart" === n.easing && (o = e * e * e * e), "easeOutQuart" === n.easing && (o = 1 - --e * e * e * e), "easeInOutQuart" === n.easing && (o = e < .5 ? 8 * e * e * e * e: 1 - 8 * --e * e * e * e), "easeInQuint" === n.easing && (o = e * e * e * e * e), "easeOutQuint" === n.easing && (o = 1 + --e * e * e * e * e), "easeInOutQuint" === n.easing && (o = e < .5 ? 16 * e * e * e * e * e: 1 + 16 * --e * e * e * e * e), n.customEasing && (o = n.customEasing(e)), o || e),
                                    $.scrollTo(0, Math.floor(r)),
                                g(r, u) || (E = $.requestAnimationFrame(v), m = t)
                            };
                        0 === $.pageYOffset && $.scrollTo(0, 0),
                            n = a,
                            e = c,
                        l || history.pushState && e.updateURL && history.pushState({
                                smoothScroll: JSON.stringify(e),
                                anchor: n.id
                            },
                            document.title, n === document.documentElement ? "#top": "#" + n.id),
                            S("scrollStart", c, a, s),
                            w.cancelScroll(!0),
                ...
                var e = function(t) {
                        if (! ("matchMedia" in $ && $.matchMedia("(prefers-reduced-motion)").matches) && 0 === t.button && !t.metaKey && !t.ctrlKey && "closest" in t.target && (i = t.target.closest(o)) && "a" === i.tagName.toLowerCase() && !t.target.closest(y.ignore) && i.hostname === $.location.hostname && i.pathname === $.location.pathname && /#/.test(i.href)) {
                            var n = c(s(i.hash)),
                                e = y.topOnEmptyHash && "#" === n ? document.documentElement: document.querySelector(n); (e = e || "#top" !== n ? e: document.documentElement) && (t.preventDefault(), w.animateScroll(e, i))
                        }
                    },
                    r = function(t) {
                        if (history.state.smoothScroll && history.state.smoothScroll === JSON.stringify(y) && history.state.anchor) {
                            var n = document.querySelector(c(s(history.state.anchor)));
                            n && w.animateScroll(n, null, {
                                updateURL: !1
                            })
                        }
                    },
                ...
                return w.destroy = function() {
                    y && (document.removeEventListener("click", e, !1), $.removeEventListener("resize", a, !1), $.removeEventListener("popstate", r, !1), w.cancelScroll(), E = n = b = _ = i = y = null)
                },
                    w.init = function(t) {
                        if (! ("querySelector" in document && "addEventListener" in $ && "requestAnimationFrame" in $ && "closest" in $.Element.prototype)) throw "Smooth Scroll: This browser does not support the required JavaScript methods and browser APIs.";
                        w.destroy(),
                            y = O(C, t || {}),
                            _ = y.header ? document.querySelector(y.header) : null,
                            b = A(_),
                            document.addEventListener("click", e, !1),
                        _ && $.addEventListener("resize", a, !1),
                        y.updateURL && y.popstate && $.addEventListener("popstate", r, !1)
                    },
                    w.init(t),
                    w
            }
    ...
    function(t, n) {
        "function" == typeof define && define.amd ? define(n) : "object" == typeof exports ? module.exports = n() : t.NProgress = n()
    } (this,
        function() {
            function e(t, n, e) {
            ...
            function i(t, n) {
                return 0 <= ("string" == typeof t ? t: r(t)).indexOf(" " + n + " ")
            }
            function a(t, n) {
                var e = r(t),
                    o = e + n;
                i(e, n) || (t.className = o.substring(1))
            }
            function n(t, n) {
                var e, o = r(t);
                i(t, n) && (e = o.replace(" " + n + " ", " "), t.className = e.substring(1, e.length - 1))
            }
            function r(t) {
            ...
            m.configure = function(t) {
                var n, e;
                for (n in t) void 0 !== (e = t[n]) && t.hasOwnProperty(n) && (u[n] = e);
                return this
            },
                m.status = null,
                m.set = function(r) {
                    ...
                    r = e(r, u.minimum, 1),
                        m.status = 1 === r ? null: r;
                    var a = m.render(!t),
                        s = a.querySelector(u.barSelector),
                        c = u.speed,
                        l = u.easing;
                    return a.offsetWidth,
                        h(function(t) {
                            var n, e, o, i;
                            "" === u.positionUsing && (u.positionUsing = m.getPositioningCSS()),
                                f(s, (n = r, e = c, o = l, (i = "translate3d" === u.positionUsing ? {
                                    transform: "translate3d(" + d(n) + "%,0,0)"
                                }: "translate" === u.positionUsing ? {
                                    transform: "translate(" + d(n) + "%,0)"
                                }: {
                                    "margin-left": d(n) + "%"
                                }).transition = "all " + e + "ms " + o, i)),
                                1 === r ? (f(a, {
                                    transition: "none",
                                    opacity: 1
                ...
                m.isStarted = function() {
                    return "number" == typeof m.status
                },
                m.start = function() {
                    m.status || m.set(0);
                    var t = function() {
                        setTimeout(function() {
                                m.status && (m.trickle(), t())
                            },
                            u.trickleSpeed)
                    };
                    return u.trickle && t(),
                ...
                m.done = function(t) {
                    return t || m.status ? m.inc(.3 + .5 * Math.random()).set(1) : this
                },
                m.inc = function(t) {
                    var n = m.status;
                    return n ? ("number" != typeof t && (t = (1 - n) * e(Math.random() * n, .1, .95)), n = e(n + t, 0, .994), m.set(n)) : m.start()
                },
                m.trickle = function() {
                    return m.inc(Math.random() * u.trickleRate)
                },
                c = o = 0,
                m.promise = function(t) {
                    return t && "resolved" !== t.state() && (0 === c && m.start(), o++, c++, t.always(function() {
                        0 == --c ? (o = 0, m.done()) : m.set((o - c) / o)
                    })),
                        this
                },
                m.render = function(t) {
                    if (m.isRendered()) return document.getElementById("nprogress");
                    a(document.documentElement, "nprogress-busy");
                    var n = document.createElement("div");
                    n.id = "nprogress",
                        n.innerHTML = u.template;
                    var e, o = n.querySelector(u.barSelector),
                        i = t ? "-100": d(m.status || 0),
                        r = document.querySelector(u.parent);
                    return f(o, {
                        transition: "all 0 linear",
                        transform: "translate3d(" + i + "%,0,0)"
                    }),
                    u.showSpinner || (e = n.querySelector(u.spinnerSelector)) && s(e),
                    r != document.body && a(r, "nprogress-custom-parent"),
                        r.appendChild(n),
                        n
                },
                m.remove = function() {
                ...
                m.isRendered = function() {
                    return !! document.getElementById("nprogress")
                },
                m.getPositioningCSS = function() {
            ...
            var h = function() {
                ...
                f = function() {
                    function o(t) {
                        return t = t.replace(/^-ms-/, "ms-").replace(/-([\da-z])/gi,
                            function(t, n) {
                        ...
                        n[t] || (n[t] = function(t) {
                            ...
                            if (t in n) return t;
                            for (var e, o = a.length,
                                     i = t.charAt(0).toUpperCase() + t.slice(1); o--;) if ((e = a[o] + i) in n) return e;
                            return t
                        } (t))
                    }
                    function r(t, n, e) {
                    ...
                    return function(t, n) {
                        var e, o, i = arguments;
                        if (2 == i.length) for (e in n) void 0 !== (o = n[e]) && n.hasOwnProperty(e) && r(t, e, o);
                        else r(t, i[1], i[2])
                    }
                } ();
            return m
    ...
    window.Aria = {
        init: function() {
            ...
            THEME_CONFIG.USE_LAZYLOAD && this.lazyload(),
                this.postOther.init(),
                console.log("%cVer " + THEME_CONFIG.THEME_VERSION + "%cAria By Siphils https://eriri.ink", "color: #fff; background: #435561; padding:6px;", "color: #fff; background: #435561cf; padding:6px;")
        },
        pjax: function() {
    ...
    Aria.commentPlus = {
        init: function() {
            this.emotion(),
                this.image(),
                this.ajaxAvatar(),
            THEME_CONFIG.USE_AJAX_COMMENT && this.ajaxComment()
        },
        emotion: function() {
            if ($(".OwO").length) new OwO({
        ...
        image: function() {
            $(".comment-image").length && ($(".comment-image")[0].onclick = function() {
                $("textarea")[0].value += "![图片描述](图片地址)"
            })
        },
        ajaxAvatar: function() {
        ...
        ajaxComment: function() {
            ...
            e(),
                $("#comment-form").submit(function() {
                    ...
                    function s(t) {
                        n.attr("disabled", !1).css("cursor", "pointer"),
                            i.css({
                                opacity: "1"
                            }),
                            $("textarea", i).css({
                            ...
                            $("input,textarea", i).attr("disabled", !1),
                        t && ($("#textarea").val(""), c = ""),
                            e()
                    }
                    return n.attr("disabled", !0).css("cursor", "not-allowed"),
                        i.css({
                            opacity: ".5"
                        }),
                        $("textarea", i).css({
                            background: 'url("' + THEME_CONFIG.THEME_URL + '/assets/img/loading.gif") center center no-repeat'
                        }),
                        $("input,textarea", i).attr("disabled", !0),
                        $.ajax({
                            ...
                            success: function(t) {
                                if (!$("#comments", t).length) {
                                    var n = "error" === $("title").eq(0).text().trim().toLowerCase() ? $(".container", t).eq(0).text() : "评论提交失败！";
                                    return a.alert(n),
                                        s(!1),
                                        !1
                                }
                                ...
                                $("input,textarea", i).attr("disabled", !1),
                                    $("#textarea").val(""),
                                    r = $(".comment-list", t).html().match(/id=\"?comment-\d+/g).join().match(/\d+/g).sort(function(t, n) {
                                        return t - n
                                    }).pop(),
                                    "" === c ? ($(".comment-list").length ? $(".prev").length || (e = $("#li-comment-" + r, t), $(".comment-list").first().prepend(e.addClass("animated fadeInUp"))) : (e = $("#li-comment-" + r, t), $("#response").after('<div class="comment-data"><ol class="comment-list"></ol></div>'), $(".comment-list").first().prepend(e.addClass("animated fadeInUp"))), $("html,body").animate({
                                            scrollTop: $("#response").offset().top - 100
                                        },
                                        1e3)) : (e = $("#li-comment-" + r, t), $("#" + c).find(".comment-children").length || $("#" + c).append('<div class="comment-children"><ol class="comment-list"></ol></div>'), $("#" + c + " .comment-children .comment-list").first().prepend(e.addClass("animated fadeInUp")), TypechoComment.cancelReply()),
                                    o = parseInt($("#response").text()),
                                    $("#response").html($("#response").html().replace(/\d+/, o + 1)),
                                    s(!0),
                                    a.confirm("评论提交成功！")
                            },
                            error: function(t) {
    ...
    Aria.action = {
        ...
        gotop: function() {
            $(window).scroll(function() {
                100 < $(window).scrollTop() ? ($("#go-top").fadeIn(500), $("#site-avatar").css({
                    height: "25px",
                    width: "25px",
                ...
                $("#go-top").click(function() {
                    var t = $("#go-top").css("bottom");
                    return $("#go-top").animate({
                        bottom: parseInt(t) + 35 + "px",
                        opacity: 0
                    }),
                        $("body,html").animate({
                                scrollTop: 0
        ...
        nav: function() {
            $("#nav-menu-btn").click(function(t) {
                $("#nav-vertical").addClass("nav-open"),
                    $("#wrapper").show()
            }),
                $("#nav-vertical>.close").on("click",
                    function() {
                ...
                $(".nav-right-item").hover(function() {
                        $(".nav-sub", this).show(),
                            $(".nav-sub", this).animateCss("flipInX")
                    },
                    function() {
                        $(".nav-sub", this).hide()
                    })
        ...
        closeNav: function() {
            return $("#nav-vertical").hasClass("nav-open") && ($("#nav-vertical").removeClass("nav-open"), $("#wrapper").removeClass("wrapper-open")),
                !1
        },
        search: function() {
